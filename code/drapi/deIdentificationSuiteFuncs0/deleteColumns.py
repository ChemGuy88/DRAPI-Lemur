...
def main(COLUMNS_TO_DELETE, COLUMNS_TO_DELETE_DICT, LIST_OF_PORTION_CONDITIONS, CHUNK_SIZE, listOfPortionDirs, runOutputDir, thisFilePath, rootDirectory, ROOT_DIRECTORY):
    """
